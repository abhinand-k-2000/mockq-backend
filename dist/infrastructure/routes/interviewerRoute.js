...
const interviewerRespository = new interviewerRepository_1.default();
const notificationRepository = new notificationRepository_1.default();
const walletRepository = new walletRepository_1.default();
const interviewerCase = new interviewerUseCase_1.default(interviewerRespository, otp, jwt, mail, hash, fileStorage, notificationRepository, walletRepository);
