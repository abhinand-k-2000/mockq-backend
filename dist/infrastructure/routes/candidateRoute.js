...
const candidateCase = new candidateUseCase_1.default(candidateRepository, otp, jwt, mail, hashPassword, notificationRepository, fileStorage);
...
router.get('/get-profile', candidateAuth_1.default, (req, res, next) => controller.getProfileDetails(req, res, next));
router.put('/edit-profile', candidateAuth_1.default, multer_1.uploadStorage.single('profilePic'), (req, res, next) => controller.editProfile(req, res, next));
router.put('/edit-password', candidateAuth_1.default, (req, res, next) => controller.editPassword(req, res, next));
